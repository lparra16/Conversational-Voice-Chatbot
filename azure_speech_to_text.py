...
class SpeechToTextManager:
    ...
    def speechtotext_from_mic(self):
        ...
        # Once the code has been run it notifies the user to speak into the microphone.
        ...
        # All of these are potential results of the speech recognition. Such as if speech was recognized or not.
        ...
        # Prints out what was recognized by Microsoft Azure
